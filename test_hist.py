        ...
        for dataset_name in dataset_names:
            ...
            for i, data in enumerate(tqdm_val):
                ...
                if opt.calc_metrics:
                    ...
                    clean_ten = torch.from_numpy(clean).unsqueeze(0).to(self.opt.device[0])
                    lpipses[i] = calc_lpips(clean_ten, res['derained_img'], loss_fn_alex_1, 'cuda:' + str(opt.gpu_ids[0]))

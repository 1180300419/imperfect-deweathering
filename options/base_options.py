...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('-j', '--num_dataloader', default=0, type=int)
        ...
        parser.add_argument('--dropoutlevel', type=int, default=0)
        ...
        # warmup
        parser.add_argument('--warmup_niter', type=int, default=4)
